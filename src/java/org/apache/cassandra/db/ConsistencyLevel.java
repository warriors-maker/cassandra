...
public enum ConsistencyLevel
{
    ...
    public static int casFor(Keyspace keyspace, int k)
    {
        return ((keyspace.getReplicationStrategy().getReplicationFactor().allReplicas+k) / 2) + 1;
    }
